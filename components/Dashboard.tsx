...
import { AlertCircle, TrendingUp, Printer } from 'lucide-react';
    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-8 print:w-full print:max-w-none">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-6">
         ...
         <div className="flex gap-2 mt-4 md:mt-0 print:hidden">
             <button onClick={handlePrint} className="flex items-center gap-2 bg-gray-100 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-200 transition">
